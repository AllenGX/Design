...
public class AniFactory
{
    ...
    public AniFactory()
    {
        aniDict = new Dictionary<string, AniInfo>
        {
            ...
            {"普通攻击",new AniInfo(0,3,7,this.rootPath+ "普通攻击") },
            {"六脉神剑",new AniInfo(0,4,9,this.rootPath+ "六脉神剑") },
            {"大火球",new AniInfo(1,5,25,this.rootPath+ "大火球",1)},
            ...
            {"道具使用",new AniInfo(0,18,17,this.rootPath+ "使用道具") },
            {"空动画",new AniInfo(0,19,4,this.rootPath+ "空动画") },
        };

        aniDicts = new Dictionary<int, Dictionary<string, List<string>>> {
            {1000,null},
            {1001, new Dictionary<string, List<string>>{ { "我方",new List<string> { } } ,{ "敌方",new List<string> { "普通攻击" } } } },
            ...
            {101, new Dictionary<string, List<string>>{ { "我方",new List<string> { } } ,{ "敌方",new List<string> { "空动画" } } } },
            {201, new Dictionary<string, List<string>>{ { "我方",new List<string> { } } ,{ "敌方",new List<string> { "空动画" } } } },
            {202, new Dictionary<string, List<string>>{ { "我方",new List<string> { } } ,{ "敌方",new List<string> { "空动画" } } } },
           { 0, new Dictionary<string, List<string>>{ { "我方",new List<string> { } } ,{ "敌方",new List<string> { "道具使用" } } } },
        };
    }
