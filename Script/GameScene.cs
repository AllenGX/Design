...
public class GameScene{
    ...
    //初始化物体
	public void Init(){
        Person p1 = new Person(1, 1000, 200, 20, 30, 11, 18, 8, 1, 0, 3, 2, 2, 3, 4, 1, 1);
        ...
        Person p2 =new Person(2, 1000, 200, 20, 30, 12, 18, 8, 1, 0, 3, 2, 2, 3, 4, 1, 1);
        ...
        Person p3=new Person(3, 1000, 200, 20, 30, 51, 18, 8, 1, 0, 3, 2, 2, 3, 4, 1, 1);
		...
		Person p4=new Person(4, 1000, 200, 20, 30, 21, 18, 8, 1, 0, 3, 2, 2, 3, 4, 1, 1);
        ...
        Person p5=new Person(5, 1000, 200, 20, 30, 35, 18, 8, 1, 0, 3, 2, 2, 3, 4, 1, 1);
        ...
        Person p6=new Person(6, 1000, 200, 20, 30, 31, 18, 8, 1, 0, 3, 2, 2, 3, 4, 1, 1);
        ...
        {
            personPositionDict[j] = enemyList[j];
        }
    ...
    //得到站位
    public int GetPos(int personID)
    {
        foreach(int iKey in this.personPositionDict.Keys)
        {
            if(personPositionDict[iKey].PersonID== personID)
            {
                return iKey;
            }
        }
