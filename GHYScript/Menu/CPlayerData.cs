...
public class CPlayerData : MonoBehaviour
{
    ...
    public int m_TaskNum = 0;
    public Vector3 player_position = new Vector3(0,0,0);

    public Person p1 = new Person(0, "小黑", 1000, 200, 20, 30, 11, 18, 8, 1, 0, 3, 2, 2, 3, 4, 1, 1, "");
    public Person p2 = new Person(1, "小绿", 1000, 200, 20, 30, 12, 18, 8, 1, 0, 3, 2, 2, 3, 4, 1, 1, "");
    public Person p3 = new Person(2, "小蓝", 1000, 200, 20, 30, 51, 18, 8, 1, 0, 3, 2, 2, 3, 4, 1, 1, "");
